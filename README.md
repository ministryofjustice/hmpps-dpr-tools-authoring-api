# hmpps-dpr-tools-authoring-api

[![repo standards badge](https://img.shields.io/badge/endpoint.svg?&style=flat&logo=github&url=https%3A%2F%2Foperations-engineering-reports.cloud-platform.service.justice.gov.uk%2Fapi%2Fv1%2Fcompliant_public_repositories%2Fhmpps-dpr-tools-authoring-api)](https://operations-engineering-reports.cloud-platform.service.justice.gov.uk/public-report/hmpps-dpr-tools-authoring-api "Link to report")
[![Docker Repository on ghcr](https://img.shields.io/badge/ghcr.io-repository-2496ED.svg?logo=docker)](https://ghcr.io/ministryofjustice/hmpps-dpr-tools-authoring-api)
[![API docs](https://img.shields.io/badge/API_docs_-view-85EA2D.svg?logo=swagger)](https://dpr-tools-authoring-api-dev.hmpps.service.justice.gov.uk/swagger-ui/index.html)
...
Our security policy is located [here](https://github.com/ministryofjustice/hmpps-dpr-tools-authoring-api/security/policy).
...
## Renaming from HMPPS Dpr Tools Authoring Api - github Actions
...
```bash
docker compose pull && docker compose up --scale hmpps-dpr-tools-authoring-api=0
```
